...
# 功能介绍
## 主界面
![在这里插入图片描述](https://img-blog.csdnimg.cn/b6fec5f28a62453bb1ab3c688e722761.png)
## 开机启动设置
设置完开机启动后就不用每次手动打开，每次需要截图或文字识别等功能就可以直接使用。
![在这里插入图片描述](https://img-blog.csdnimg.cn/5e1b2d84e2fc4449be2fabde91b18095.gif)
## 快捷键设置
可通过快捷键设置对截图、贴图、文字识别、表格识别等功能进行快捷调用。
![在这里插入图片描述](https://img-blog.csdnimg.cn/00d1a55ce1ca43f59cbbfe9f08dce523.gif)
## 百度云信息设置
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/d36e63697f93435f9116653dcfddbd96.gif)
## 截图文字识别
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/2a7b7784916c4722a51fc901d67673a2.gif)
# 代码实现
## PrScrn.dll截图库使用
